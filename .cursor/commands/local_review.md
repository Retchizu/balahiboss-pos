...
3. **Set up the remote and worktree**:
   ...
   - If not, add it: `git remote add USERNAME git@github.com:USERNAME/bot-bot`
   - Fetch from the remote: `git fetch USERNAME`
   - Create worktree: `git worktree add -b BRANCHNAME ~/wt/bot-bot/SHORT_NAME USERNAME/BRANCHNAME`
...
4. **Configure the worktree**:
   ...
   - The `memory-bank/` directory is tracked in git and will be present in the worktree automatically.
...
- Create worktree at `~/wt/bot-bot/eng-1696`
