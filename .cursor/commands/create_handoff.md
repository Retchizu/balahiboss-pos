...
Use the following information to understand how to create your document:
   - create your file under `memory-bank/shared/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
...
researcher: [Researcher name from memory-bank status]
...
Once this is completed, you should respond to the user with the template between XML tags. do NOT include the tags in your response.
...
for example (between XML tags - do NOT include these tags in your actual response to the user)

Handoff created and synced! You can resume from this handoff in a new session with the following command:

```bash
/resume_handoff memory-bank/shared/handoffs/ENG-2166/2025-01-08_13-44-55_ENG-2166_create-context-compaction.md
```
