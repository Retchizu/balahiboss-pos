    ...
    >
      ...
      <View style={styles.currentPrinterContainer}>
        <View style={styles.currentPrinterHeader}>
          ...
          />
          <Text style={styles.currentPrinterTitle}>Current Printer</Text>
        </View>
        <View
          style={[
      ...
      <View style={styles.refreshContainer}>
        ...
        >
          <MaterialIcons
            ...
            style={[
              styles.refreshIcon,
              (isScanning || refreshing) && styles.refreshIconSpinning,
            ]}
          />
          <Text style={styles.refreshButtonText}>
            {isScanning || refreshing ? "Scanning..." : "Refresh Devices"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      >
        ...
        <View style={styles.sectionContainer}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>
              Paired Devices ({pairedDevices.filter((d) => d.name).length})
            </Text>
          </View>

          {initialLoading || isScanning ? (
            <View style={styles.loadingContainer}>
              <ActivityIndicator color={strongPrimary} size={wp(8)} />
              ...
              {pairedDevices
                ...
                .map((item, index) => (
                  <View
                    ...
                    style={[
                      styles.deviceCard,
                      isCurrentPrinter(item) && styles.deviceCardSelected,
                    ]}
                  >
                    <View style={styles.deviceCardContent}>
                      <View style={styles.deviceIconContainer}>
                        <MaterialCommunityIcons
                          name="printer"
                          size={wp(7)}
                          color={isCurrentPrinter(item) ? strongPrimary : "#666"}
                        />
                      </View>
                      <View style={styles.deviceInfo}>
                        <Text
                          style={[
                            styles.deviceName,
                            isCurrentPrinter(item) && styles.deviceNameSelected,
                          ]}
                        >
                          {item.name}
                        </Text>
        ...
        <View style={styles.sectionContainer}>
          <View style={styles.sectionHeader}>
            ...
            />
            <Text style={styles.sectionTitle}>
              Available Devices ({foundDevices.filter((d) => d.name).length})
            </Text>
          </View>
      ...
      {isSavingCurrentPrinter && (
        <View style={styles.loadingOverlay}>
          <View style={styles.loadingOverlayContent}>
            ...
            <Text style={styles.loadingOverlayText}>Setting printer...</Text>
          </View>
        </View>
      )}
    </View>
