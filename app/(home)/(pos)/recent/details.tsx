...
const RecentTransactionDetailScreen = () => {
  ...
  const { transactionMap } = useConvertTransactionArrayToMap(true);
  ...
  return (
    ...
    >
      ...
      <TransactionDetailCardView height={hp(35)}>
        <View
          style={{ flexDirection: "row", gap: wp(1), alignItems: "center" }}
        >
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        <TransactionDetailCardView height={hp(10)} width={role === "admin" ? wp(45): wp(96)}>
          <Text
            style={{
